...
length: 6,
emote: ":star1:",
labels: ["Firm ID", "Client's Company ID", "Case #", "Description of the Issue", "Customer's Goal (What is the customer trying to achieve?)", "KBs Researched"],
ids: ["firmid", "clientid", "casenumber", "issuedescription", "customergoal", "kbsresearched"],
types: ["text", "text", "text", "textarea", "textarea", "text"],
placeholders: ["e.g. 123187956452310", "e.g. 123187956452310", "e.g. 123654897", "e.g. Customer is unable to run payroll because the account is still on an NSF hold.", "e.g. Remove NSF hold since it has been paid, then run payroll", "e.g. ID6523165"],
